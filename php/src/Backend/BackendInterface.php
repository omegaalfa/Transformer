...
interface BackendInterface extends AlgebraBackendInterface, ElementWiseBackendInterface, ShapeBackendInterface, ActivationBackendInterface, EmbeddingBackendInterface, NormalizationBackendInterface
{
